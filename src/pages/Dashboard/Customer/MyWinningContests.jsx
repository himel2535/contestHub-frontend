// src/pages/Dashboard/Customer/MyWinningContests.jsx
...
const MyWinningContests = () => {
  ...
  if (winningContests.length === 0) {
    return (
      <div className="text-center py-20 bg-white shadow-xl rounded-lg mx-auto max-w-2xl border-2 border-dashed border-gray-300">
                ...
                <div className="text-xs text-gray-600">
                  <p>
                    ...
                    {contest.winner?.declaredAt 
                      ? format(new Date(contest.winner.declaredAt), 'MMM dd, yyyy')
                      : 'N/A'}
                  </p>
                </div>
              </div>
