  ...
  return (
    <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border-t-4 border-yellow-500">
      ...
      <div className="mt-4 text-sm font-medium text-gray-600">
        ...
        <p className="text-gray-400">Participated: {participated.toFixed(2)}%</p>
      </div>
    </div>
  );
};
...
const CategoryBarChart = ({ categoryStats }) => {
    if (categoryStats.length === 0) {
        return <p className="text-gray-500">No participation data available for categories.</p>;
    }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-yellow-500 flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-extrabold text-gray-900 mt-1">{participationCount}</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-yellow-500 flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-extrabold text-gray-900 mt-1">{winCount}</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-yellow-500 flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-500">Overall Win Rate</p>
            <p className="text-3xl font-extrabold text-gray-900 mt-1">{winPercentage}%</p>
          </div>
