...
const CustomTooltip = ({ active, payload, label, resolvedTheme }) => {
  if (active && payload && payload.length) {
    return (
      <div
        className={`p-2 border rounded-lg shadow-md text-sm ${
          resolvedTheme === "dark"
      ...
      <div className="flex-grow min-h-[350px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              content={<CustomTooltip resolvedTheme={resolvedTheme} />}
            />
...
const CreatorStatistics = () => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 py-8 bg-white dark:bg-gray-900 min-h-screen overflow-hidden">
      <div
      ...
      <p
        ...
        data-aos-delay="100"
      >
        View key metrics related to your created contests, total revenue
        generated, and a detailed breakdown of your contests by status (Pending,
        Confirmed, Completed).
      </p>
