...
const WinnerLeaderboard = () => {
  ...
  return (
    <Container>
      {/* overflow lock */}
      <div className="py-16 dark:bg-gray-900 transition-colors duration-500 overflow-x-hidden">
        {/* ---------- Header ---------- */}
        ...
        {/* ---------- Stats Cards ---------- */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16 px-4 sm:px-6">
          {/* Winners */}
          ...
          {heroWinner && (
            <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl border-t-8 border-yellow-500 text-center lg:sticky lg:top-10">
              ...
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                Conquered:{" "}
                <span className="font-semibold">{heroWinner.contestName}</span>
              </p>
        ...
        {/* ---------- CTA ---------- */}
        <div className="mt-16 text-center bg-yellow-100 dark:bg-gray-800 p-8 rounded-2xl shadow-inner mx-4 sm:mx-6">
