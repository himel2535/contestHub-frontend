...
const PopularContests = () => {
  const { data, isPending, isError } = useQuery({
    ...
    queryFn: async () => {
      // API কল: এখানে আমরা /contests রুট থেকে ডেটা নিচ্ছি
      // এবং ধরে নিচ্ছি এটি পেজিনেশন সহ অবজেক্ট ফরম্যাট { contests: [...] } পাঠাবে।
  ...
  // 💡 ফিক্স: ডেটা অবজেক্ট থেকে 'contests' অ্যারেটি বের করে নিন।
  // যদি data না থাকে বা data.contests না থাকে, তবে একটি খালি অ্যারে ব্যবহার করুন।
  const contestsArray = data?.contests || []; 

  // sort by highest participantsCount এবং প্রথম ৫টি নিন
    ...
    <Container>
      <div className="py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            {/* ফিক্সড অ্যারেতে ম্যাপ করা হচ্ছে */}
